...
const Navbar = props => {
    ...
    return (
        <Box
            ...
            {...props}
        >
            <Container display="flex" p={2} maxWW="container.md" wrap="wrap" align="center" justify="space-between" >
                    ...
                    <Box ml={2} display={{base: 'inline-block' ,md: 'none' }}>
                        <Menu>
                            ...
                            <MenuList>
                                ...
                                <MenuItem as={Link} href="https://www.facebook.com">View Profile</MenuItem>
                            </MenuList>
                        </Menu>
                    </Box>
                </Box>
